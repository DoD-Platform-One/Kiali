...
| cr.spec.deployment.cluster_wide_access | bool | `true` |  |
| cr.spec.deployment.image_name | string | `"registry1.dso.mil/ironbank/opensource/kiali/kiali"` |  |
| cr.spec.deployment.image_version | string | `"v2.9.0"` |  |
